...
exports.contracts = {
    energy: typechain_types_1.Energy__factory.connect(addresses_1.contractAddresses.energy),
    authority: typechain_types_1.Authority__factory.connect(addresses_1.contractAddresses.authority),
    extension: typechain_types_1.Extension__factory.connect(addresses_1.contractAddresses.extension),
    params: typechain_types_1.Params__factory.connect(addresses_1.contractAddresses.params),
