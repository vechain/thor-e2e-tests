...
export interface components {
  schemas: {
     ...
     * }
     */
    ExecuteCodesRequest: components["schemas"]["ExtendedCallData"] & components["schemas"]["BatchCallData"];
    /**
     * @example [
     *   {
     ...
     * }
     */
    GetTxResponse: OneOf<[components["schemas"]["Tx"] & {
     ...
     * }
     */
    GetBlockResponse: components["schemas"]["Block"] & components["schemas"]["IsTrunk"] & components["schemas"]["IsFinalized"] & (OneOf<[{
      /** @description An array of transaction IDs */
      transactions?: string[];
    }, {
      /** @description All included transactions, expanded, to include their receipts */
      transactions?: (components["schemas"]["Tx"] & components["schemas"]["Receipt"])[];
    }]>);
    ...
    SubscriptionBlockResponse: components["schemas"]["Block"] & components["schemas"]["Obsolete"] & {
      /** @description An array of transaction IDs associated with the block. */
      transactions?: string[];
    };
    SubscriptionEventResponse: components["schemas"]["Event"] & components["schemas"]["Obsolete"] & {
      meta?: components["schemas"]["LogMeta"];
    };
    SubscriptionTransferResponse: components["schemas"]["Transfer"] & components["schemas"]["Obsolete"] & {
      meta?: components["schemas"]["LogMeta"];
    };
     ...
     * }
     */
    PostDebugTracerRequest: components["schemas"]["TracerOption"] & components["schemas"]["ClauseTracerOption"];
    /**
     * @example {
     *   "value": "0x0",
     *   "to": "0x0000000000000000000000000000456E65726779",
     ...
     * }
     */
    PostDebugTracerCallRequest: components["schemas"]["TracerOption"] & components["schemas"]["CallData"] & components["schemas"]["ExtendedCallData"];
    /**
    ...
    TracerOption: {
       ...
       * @enum {string|null}
       */
      name?: "" | "4byte" | "call" | "noop" | "prestate" | "unigram" | "bigram" | "trigram" | "evmdis" | "opcount" | null;
      /**
